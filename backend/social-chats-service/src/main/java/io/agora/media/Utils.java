...
/**
 * Utility helpers used by the Agora AccessToken2 builder.
 */
public final class Utils {
    ...
    public static byte[] hmacSign(byte[] keyBytes, byte[] msg) throws InvalidKeyException, NoSuchAlgorithmException {
