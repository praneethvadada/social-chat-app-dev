...
/**
 * Minimal implementation of Agora AccessToken2 (version 007) for RTC tokens.
 * Based on Agora's open-source token builder (MIT licensed).
 */
public class AccessToken2 {
    ...
    public String build() throws Exception {
        ...
        bufferContent.putRaw(buf.asBytes());
    ...
    public static class Service {
        ...
        protected TreeMap<Short, Integer> privileges = new TreeMap<>();
